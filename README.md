...
- [Сценарии взаимодействия пользователя с приложением](#сценарии-взаимодействия-пользователя-с-приложением)
- [Структура базы данных](#структура-базы-данных)
- [Документация кода](#документация-кода)
- [Примеры использования проекта](#примеры-использования-проекта)
...
Таблица подготовлена под будущий список желаемых книг.
...
- [Moodle USM](https://elearning.usm.md/)
- [Документация PHP: PDO](https://www.php.net/manual/ru/book.pdo.php)
- [Документация PHP: password_hash](https://www.php.net/manual/ru/function.password-hash.php)
